...
exports = module.exports = {
	...
	'controlledassign': {
		description: "(extra) Allow assignments in conditional expressions"
	},
	'eqeq:null': {
		description: "(extra) Allow comparisions to null (e.g. x == null)"
	},
	'evil:function': {
		description: "(extra) Allow Function constructors"
	},
	'in': {
		description: "(extra) Allow 'in' statement"
	},
	module: {
	...
	objfn: {
		description: "(extra) Allow Object function calls"
	},
	'white:commafirstvar': {
		description: "(extra) Allow variable declarations with commas at begin of "
			+ "line"
	}
};
